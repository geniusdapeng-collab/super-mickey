...
const STAGE_DEGRADATION_CONFIG = {
  ...
  'STAGE-5': {
    ...
    mockData: {
      scenes: [
        { id: 'S01', scene: 'opening', content: 'wide establishing shot, golden hour light filtering through windows, protagonist enters frame left with purposeful gait', narration: 'opening narration: setting the world, hinting at the journey ahead' },
        { id: 'S02', scene: 'discovery', content: 'medium close-up, hands reaching toward unknown object, dust particles suspended in shaft of light, eyes widening with curiosity', narration: 'rising tension: the moment everything changes' },
        { id: 'S03', scene: 'climax', content: 'tight frame around face, sweat bead catching rim light, breath visible in quickened rhythm, decisive action frozen in time', narration: 'peak moment: the point of no return' }
      ]
    },
        ...
        shots: [
          {
            ...
            sequence: 1,
            scene: 'opening',
            visualPrompt: 'wide establishing shot, protagonist silhouetted against vast alien landscape, twin suns casting long dual shadows, bioluminescent flora pulsing in foreground',
            mood: 'awe and isolation',
            camera: 'static wide, slow push-in'
          },
          {
            id: 'S02',
            sequence: 2,
            scene: 'discovery',
            visualPrompt: 'medium shot, protagonist leaning forward with hand reaching toward glowing artifact, dust particles suspended in shaft of amber light',
            mood: 'curiosity building',
            camera: 'tracking shot following hand movement'
          }
        ]
      }
    },
