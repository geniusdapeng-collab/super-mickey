# 超级小香宝（HyperrealitySystem）镜头字段规范 v2.1.4-fix9

> **文档目的**：明确预生产链路最终输出的完整字段列表、业务含义、生成来源及在渲染中的作用。
>
> **适用范围**：超级小香宝 v2.1.4-fix9+，所有预生产任务
>
...
**应包含内容**：
```
image://characters/example-character/portraits/example-character-front.png
image://characters/example-character/portraits/example-character-threeQuarter.png
image://characters/example-character/portraits/example-character-closeup.png
image://characters/example-character/portraits/example-character-side.png
```
...
**应包含内容**：
```
保持主讲人角色形象一致，短发警服造型不变，面部特征与体型每帧统一，同一人出镜
```
