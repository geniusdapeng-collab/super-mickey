# 超现实系统 (Hyperreality System) - 完整全量代码包

> 打包时间: 2026-06-24T18:28:10.994Z
> 文件总数: 84
> 总代码行数: 23305
> 总大小: 718.2 KB (0.70 MB)
> 范围: 仅包含 hyperreality-system 目录
> 已排除: _deprecated_scripts, checkpoints, output, debug_llm, debug-shot-records, backup-placeholders, 二进制文件
...
## characters/chen-zhuo/character-card.json
...
```json
{
  ...
  "visualIdentity": {
    ...
    "distinguishingMarks": "",
    "outfit": "dark navy blue police uniform wool coat with complete shoulder insignia, light blue cotton shirt underneath, black formal trousers, black leather shoes",
    "appearance": {
      "style": "cartoon",
      "type": "police professional uniform",
      "variant": "cartoon style police uniform"
    }
  },
  "personality": {
    "core": "warm",
  ...
  "createdAt": "2026-06-18T13:13:32.651Z",
  "updatedAt": "2026-06-18T13:13:32.651Z",
  "version": "2.1",
  "generatedAssets": {
    "portraits": [
      "image://characters/chen-zhuo/portraits/chen-zhuo-cartoon-front.png",
      "image://characters/chen-zhuo/portraits/chen-zhuo-cartoon-v2-front.png",
      "image://characters/chen-zhuo/portraits/chen-zhuo-cartoon-v3-side.png",
      "image://characters/chen-zhuo/portraits/chen-zhuo-cartoon-side.png",
      "image://characters/chen-zhuo/portraits/chen-zhuo-cartoon-fullbody.png"
    ],
    "referenceImages": []
  },
  "appearances": [],
  "v2Metadata": {
    ...
    "promptTemplates": {},
    "minimalAnchor": "陈卓: 人类, 35-40岁女性, 穿警服",
    "portraitPaths": [
      "image://characters/chen-zhuo/portraits/chen-zhuo-cartoon-front.png",
      "image://characters/chen-zhuo/portraits/chen-zhuo-cartoon-v2-front.png",
      "image://characters/chen-zhuo/portraits/chen-zhuo-cartoon-v3-side.png",
  ...
  async process(shots, blueprint) {
    ...
    const designedShots = shots.map((shot, index) => {
      ...
      if (hasForbidden) {
        ...
        // 根据镜头索引分配兜底场景
        const fallbackScenes = [
          '场景A: 医院健康宣教室，白色荧光灯均匀照明，白墙面贴有无文字骨骼肌解剖图与运动损伤海报（纯图形版），木质讲台表面带有细微使用划痕',
          '场景B: 三甲医院检验科走廊，冷白色LED光源从走廊顶部连续排列向下照射，无文字箭头标识牌指向尿液检验窗口，地面为浅色抛光瓷砖',
          '场景C: 医生诊室，白色墙面悬挂无文字人体解剖示意图（纯图形版），办公桌摆放听诊器与血压计，检查床铺有蓝色一次性床单，无影灯悬于上方',
          '场景D: 医院健康管理中心，嵌入式LED灯带洒下柔和暖白光，接待台后方排列无文字健康宣传展板（纯图形版），前方摆放皮质沙发与实木茶几'
        ];
...
## engines/script-engine/core/series-content-planner.js
