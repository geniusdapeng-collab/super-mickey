...
> 导出时间: 2026-06-18T14:24:22.859Z
> 系统: 超现实系统 (Hyperreality System)
> 说明: 包含全部代码、配置、文档，不含中间生产数据

---

# 📦 hyperreality-system

路径: `/root/.openclaw/workspace/hyperreality-system` | 文件数: 26

## 📄 hyperreality-system/.current-version
...
## 📄 hyperreality-system/output/field-mapping-analysis.md
...
## 📄 hyperreality-system/output/gap-analysis-v1.2.0-to-v6.37.md
