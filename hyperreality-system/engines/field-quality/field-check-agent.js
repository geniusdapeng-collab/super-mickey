...
const FIELD_SPECS = [
  // P0 致命级（12个，必填）
  { nameCn: '导演指令', nameEn: 'director_instruction', priority: Priority.P0, charMin: 50, charMax: 120, required: true },
  ...
  { nameCn: '场景', nameEn: 'scene', priority: Priority.P0, charMin: 120, charMax: 200, required: true },
  { nameCn: '灯光', nameEn: 'lighting', priority: Priority.P0, charMin: 100, charMax: 180, required: true },
  { nameCn: '运镜', nameEn: 'camera_movement', priority: Priority.P0, charMin: 60, charMax: 120, required: true },
  { nameCn: '角色', nameEn: 'character', priority: Priority.P0, charMin: 50, charMax: 120, required: true },
  { nameCn: '动作', nameEn: 'action', priority: Priority.P0, charMin: 100, charMax: 180, required: true },
  ...
  // P1 核心级（7个，必填）
  { nameCn: '构图', nameEn: 'composition', priority: Priority.P1, charMin: 80, charMax: 140, required: true },
  { nameCn: '色彩', nameEn: 'color_palette', priority: Priority.P1, charMin: 60, charMax: 120, required: true },
  { nameCn: '景深', nameEn: 'depth_of_field', priority: Priority.P1, charMin: 50, charMax: 100, required: true },
  { nameCn: '时间轴', nameEn: 'timeline', priority: Priority.P1, charMin: 100, charMax: 180, required: true },
  ...
  { nameCn: '音频', nameEn: 'audio', priority: Priority.P2, charMin: 40, charMax: 100, required: false },
  // P3 可选级（2个，可选）
