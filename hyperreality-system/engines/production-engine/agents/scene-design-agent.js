...
【强制要求 - 违反则任务失败】
- 场景必须是**写实真实环境**：三甲医院诊室、检验科走廊、医院宣教室、健康管理中心
- **绝对禁止**科幻元素：全息投影、虚拟空间、未来感、霓虹特效、元宇宙、数字空间
- **绝对禁止**抽象描述："空间折叠"、"时间残影"、"微观世界"、"数据洪流"、"抽象几何"
- **绝对禁止**概念词汇："元演播"、"虚拟"、"全息"、"数字化"、"光影操控"
- **场景变化要求**：每2-3个镜头必须切换场景，保持视觉新鲜感
  - 场景A：医院健康宣教室（荧光顶灯，白墙面，健康知识海报）
  - 场景B：三甲医院检验科走廊（冷白光源，指示牌，检验窗口）
  - 场景C：诊室内部（听诊器、血压计、检查床、医学挂图）
