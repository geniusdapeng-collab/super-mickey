...
const OUTPUT_FILE = path.join(WORKSPACE, 'output', 'zhuoyue-systems-v6.5-complete.md');
...
const PACK_DIRS = [
  ...
  { dir: 'hyperreality-system', label: '超级小香宝' },
  // 引擎层
...
md = '# 卓越系统 v6.5 全量代码（完整版 - 补充遗漏）\n\n' +
     '> 打包时间: ' + new Date().toISOString() + '\n' +
     '> 文件总数: ' + totalFiles + '\n' +
     '> 总字符数: ' + (totalSize / 1024 / 1024).toFixed(2) + ' MB\n' +
     '> 打包范围: 卓越主系统 + 超短裙系统 + Seedance 子系统 + 山海经子系统 + 超级小香宝 + 引擎层 + 核心层 + 脚本 + 应用层 + 工具 + 文档 + 配置 + 模板 + 数据 + 角色档案 + 代理系统 + 共享内核 + 领域层 + 分析 + 故事项目 + 生产项目 + 生产产物\n' +
