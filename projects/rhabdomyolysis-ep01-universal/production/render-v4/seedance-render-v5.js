...
const MODEL = 'ep-20260518004622-jp46s'; // 自定义接入点（之前成功的端点）
...
// 状态跟踪（新文件）
const statusFile = renderDir + '/render-status-v5.json';
let status = {};
...
async function batchSubmit() {
  console.log('🚀 CG版角色一致性渲染 - 开始批量提交 ' + tasks.length + ' 个镜头');
  console.log('🎨 使用CG版定妆照保证角色统一');
