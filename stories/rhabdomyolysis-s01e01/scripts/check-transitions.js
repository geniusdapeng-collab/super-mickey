...
const tasks = [
  { id: 'cgt-20260521174333-v2495', shot: 'T3' },
  { id: 'cgt-20260521174355-4pbcm', shot: 'T7' }
];

const outputDir = '/root/.openclaw/workspace/stories/rhabdomyolysis-s01e01/production/videos-v44';
  ...
  while (!allDone && attempts < maxAttempts) {
    ...
    for (const task of tasks) {
      ...
      if (result.status === 'succeeded') {
        ...
        const outputPath = path.join(outputDir, `${result.shot}-v44.mp4`);
